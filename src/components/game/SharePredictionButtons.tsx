...
export function SharePredictionButtons(props: SharePredictionButtonsProps) {
  ...
  const shareText = `🏈 NFL Week ${props.week} AI Prediction\n${props.awayFull} vs ${props.homeFull}\n🏆 Model Pick: ${winnerFull} (${props.confidence.toFixed(0)}% confidence)\n\nFull analysis 👇`;
  ...
  async function handlePlatform(id: string) {
    ...
    try {
      ...
      const urls: Record<string, string> = {
        ...
        youtube:  `https://m.youtube.com/@nflpredictshub`,
      };
  ...
  return (
    <div className="rounded-xl border border-border bg-card p-5">
      ...
      <p className="text-xs text-muted-foreground mb-4 leading-relaxed">
        Tap a platform to download the prediction card PNG and open the share dialog.
      </p>
