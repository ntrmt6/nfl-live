/**
 * Fixes white-text-on-light-bg issue in the Cardinals vs Panthers post.
 * Run: node scripts/fix-cardinals-panthers-css.mjs
 */
...
const content = `
<style>
  /* All card backgrounds use solid dark colors so white text is readable on the light-theme site */
  .card{background:#111827;border:1px solid rgba(255,255,255,0.1);border-radius:14px;padding:1.8rem;margin-bottom:1.8rem}
  ...
  .fact-box{background:rgba(255,255,255,0.07);border:1px solid rgba(255,255,255,0.12);border-radius:10px;padding:0.8rem 1rem;text-align:center}
  ...
  .countdown-unit{background:rgba(255,255,255,0.07);border:1px solid rgba(255,255,255,0.12);border-radius:10px;padding:0.6rem 1rem;min-width:60px;text-align:center}
  ...
  .stream-option{display:flex;gap:1rem;align-items:flex-start;padding:1.1rem 1.2rem;border-radius:12px;border:1px solid rgba(255,255,255,0.1);background:rgba(255,255,255,0.05);margin-bottom:0.8rem;transition:border-color 0.2s}
  .stream-option:hover{border-color:rgba(0,133,202,0.5)}
  ...
  .stream-icon.blue{background:rgba(0,133,202,0.2)}
  .stream-icon.red{background:rgba(227,24,55,0.18)}
  .stream-icon.dark{background:rgba(255,255,255,0.12)}
  .stream-icon.green{background:rgba(34,197,94,0.15)}
  ...
  .tag-blue{background:rgba(0,133,202,0.18);color:#38bdf8;border:1px solid rgba(0,133,202,0.25)}
  .tag-yellow{background:rgba(234,179,8,0.15);color:#fbbf24;border:1px solid rgba(234,179,8,0.2)}
  .tag-red{background:rgba(151,35,63,0.22);color:#f87171;border:1px solid rgba(151,35,63,0.3)}
  .score-display{display:flex;align-items:center;justify-content:center;gap:2rem;padding:1.5rem;background:rgba(255,255,255,0.06);border-radius:12px;margin-top:1.2rem}
  ...
  .prob-bar{height:10px;border-radius:10px;background:rgba(255,255,255,0.1);overflow:hidden;display:flex}
  ...
  .odds-card{background:rgba(255,255,255,0.07);border:1px solid rgba(255,255,255,0.12);border-radius:10px;padding:1rem;text-align:center}
  ...
  .poll-btn{background:rgba(255,255,255,0.08);border:1.5px solid rgba(255,255,255,0.15);border-radius:10px;padding:1rem;cursor:pointer;transition:all 0.2s;text-align:center;color:#fff;font-weight:700;font-size:0.9rem}
  .poll-btn:hover{border-color:rgba(255,255,255,0.3);background:rgba(255,255,255,0.12)}
  .poll-btn.voted-ari{border-color:#97233F;background:rgba(151,35,63,0.2)}
  .poll-btn.voted-car{border-color:#0085CA;background:rgba(0,133,202,0.2)}
  ...
  .poll-bar-outer{height:8px;background:rgba(255,255,255,0.1);border-radius:8px;overflow:hidden}
  ...
  .prediction-box{background:linear-gradient(135deg,#1a0a10 0%,#0a111a 100%);border:1px solid rgba(255,255,255,0.1);border-radius:14px;padding:1.5rem;text-align:center}
  ...
  .watch-tip{background:rgba(0,133,202,0.12);border:1px solid rgba(0,133,202,0.25);border-radius:10px;padding:0.9rem 1.1rem;margin-top:1rem;font-size:0.82rem;color:rgba(255,255,255,0.75);line-height:1.5}
...
<div class="card">
  ...
  <div style="display:grid;grid-template-columns:1fr 1fr;gap:0.8rem">
    <div style="background:rgba(255,255,255,0.08);border:1px solid rgba(255,255,255,0.15);border-radius:10px;padding:1rem">
      <div style="font-size:0.7rem;font-weight:700;color:rgba(255,255,255,0.45);text-transform:uppercase;letter-spacing:0.06em;margin-bottom:0.5rem">NFL Sunday Ticket</div>
    ...
    <div style="background:rgba(255,255,255,0.08);border:1px solid rgba(255,255,255,0.15);border-radius:10px;padding:1rem">
      <div style="font-size:0.7rem;font-weight:700;color:rgba(255,255,255,0.45);text-transform:uppercase;letter-spacing:0.06em;margin-bottom:0.5rem">DirecTV Stream</div>
...
try {
  ...
  console.log("CSS fixed for:", slug);
} finally {
  await client.close();
}
